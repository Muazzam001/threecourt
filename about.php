...
<head>
    ...
    <title>ThreeCourt, LP :: About</title>
...
<center>
	...
	<div class="content pages-padding">
		...
		<ce oet="1">
		    <p class="regUnderlined" style="border-top:none;">Three Court, LP is a New York based investment
			firm founded in 2012. Our investment strategy is event-driven and follows a fundamental, value
			approach. Three Court invests across a spectrum of asset classes including domestic and foreign
			equity, credit, distressed securities, liquidations and merger arbitrage. Investments are
			typically made with a long-term investment horizon. We utilize no leverage in the portfolio and
			maintain a long-biased orientation, while concentrating our capital on our best ideas.</p>


		    <!-- <p class="regUnderlined">ThreeCourt focuses on opportunities across the corporate asset structure and across the distressed cycle to find investments with attractive risk reward ratios.  The goal is to provide equity-like returns with credit-like risk and volatility in an uncorrelated fashion.</p>
		<p class="regUnderlined"><a href="team.php">Our team</a> is managed by <a href="team.php?PERSON=THREECOURT">Three Court</a>, President and Chief Investment Officer of ThreeCourt, LP Founded in 2012, but with over 100 years of combined distressed investing experience, ThreeCourt seeks to combine the advantages of a newer firm with the experience of a proven team.</p> -->
		</ce>
	    </div>
    ...
    <div id="footer" class="pages-footer">
	<div class="container-fluid">
		...
		<div class="footRight foot-right-res">
			...
			<a>Terms of Use & Privacy Policy</a></p>
		</div>
	    </div>
	</div>
    </div>
