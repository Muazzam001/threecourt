...
if (isset($_POST['submit1'])) {
    ...
    $message = 'Full Name: ' . $fname . '<br> Email :' . $email . '<br>'
	. ' Phone :' . $phone . '<br>Company Name :' . $company_name . '<br>Country :' . $country
	. '<br>City : ' . $city . ' <br> Description :' . $msg;
    $headers = 'From: ' . $email . '' . "\r\n" .
	'Bcc: ' . $email . '' . "\r\n" .
	'Content-Type: text/html; X-Mailer: PHP/' . phpversion();
    $subject = "Message sent using your contact form of threecourt.com";
    $to = 'arthur.kavalis@threecourt.com, engr.aamir.kamal2015@gmail.com';
//         arthur.kavalis@threecourt.com                $from = "From: $email";
...
<head>
    ...
    <title>ThreeCourt, LP ::Message</title>
...
<center>
	...
	<div class="content">
		...
		<p class="innerBig">Send us a message</p>
		...
		<form name="request" action="" method="post" enctype="multipart/form-data">
			...
			<tr>
			    ...
			    <td style="padding-left: 3px;" class="answer1">
				<select name="COUNTRY" onchange="ccountry();">
			...
			<tr class="">
			    ...
			    <td class="answer1"><input type="text" name="city"></td>
			</tr>
			<tr class="">
			...
			<!-- <tr class=""><td class="question2">Message: <strong>*</strong></td><td class="answer2">
		...
		<tr>
		    <td colspan="2">
			<input class="submitRegister" type="submit" value=" Submit " name="submit1"
			       onClick="submit_form()">
