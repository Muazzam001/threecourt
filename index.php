...
<head>
    ...
    <title>ThreeCourt, LP :: Welcome</title>
    ...
    <!-- <link href="cs/fx.css" rel="stylesheet" type="text/css" /> -->
	...
	<table cellpadding="0" cellspacing="0" id="login-table">
		...
		<td valign="top">
		    <input type=text name=USERNAME id=USERNAME
			   style="background-image:url(img/user.png); background-repeat: no-repeat; background-position: 1px center"
			   onfocus="clear_box(0);" onblur="toggle_box(0);"></td>
	    </tr>
	    <tr>
		<td class="login-pswd">
		    <input type=password name=PASSWORD id=PASSWORD
			   style="background-image:url(img/password.png); background-repeat: no-repeat; background-position: 1px center"
			   onfocus="clear_box(1);" onblur="toggle_box(1);">
		</td>
	    </tr>
	    <tr>
		<td>
		    <p>By clicking this Log In box, you attest that you are using Log In credentials provided
			specifically to you by ThreeCourt.</p>
		</td>
	    </tr>
	    <tr>
		...
		<td valign="top" align="left" style="padding-top:7px"><a onclick="javascript:forgot_pw()">Forgot your
			password?</a>
		    <br/> <a href="request-access">Request Access</a></td>
	    </tr>
	    <tr>
		<td colspan="2">
		    <div id="msg"></div>
...
<center>
    ...
    <nav class="navbar navbar-inverse bg-color" id="topBarCont">
	<div class="container-fluid" id="top-bar">
      ...
      ?>
		...
		<ul class="nav navbar-nav nav-index" id="nav"
	...
	<div class="content">
	    ...
	    <div class="row homeCont">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		    <a href="index" id="homeImage"></a>
		</div>
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		    <p class="homeBig">EVENT-DRIVEN VALUE INVESTING</p>
		    <ul class="heading">
			<li>Credit</li>
			<li>Equity</li>
			<li>Arbitrage & Liquidations</li>
		    </ul>
		    <!-- <p>Value investors across the capital structure Preservation of capital first and return on capital second Concentrated, long-term investments.</p> -->
		</div>
	    </div>
	    <script>
		$(document).ready(function () {
			...
			$('#container.home').css({
			    'display': 'table-cell'
			    , 'height': $(window).height() - $('#footer').height() - $('#topBarCont').height() + 'px'
			});
		    });
		    $(window).resize();
		    setTimeout(function () {
